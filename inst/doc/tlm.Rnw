...
%\texttt{jose.barrera@isglobal.org}
%\and
%Xavier Basaga\~na$^{\text{a},\text{b},\text{c}}$\\
%\texttt{xavier.basagana@isglobal.org}
%}
...
\affil[1]{ISGlobal, Centre for Research in Environmental Epidemiology (CREAL)}
...
\bibitem{Barreratlm2014} Barrera-G\'omez J, Basaga\~na X. Models with transformed variables: interpretation and software. \emph{Epidemiology}. 2015;26(2):e16-17. DOI: 10.1097/EDE.0000000000000247.
